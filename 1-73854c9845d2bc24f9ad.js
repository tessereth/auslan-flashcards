;(window.webpackJsonp = window.webpackJsonp || []).push([
  [1],
  {
    145: function(e, a, n) {
      'use strict'
      n.r(a),
        n.d(a, 'graphql', function() {
          return p
        }),
        n.d(a, 'StaticQueryContext', function() {
          return m
        }),
        n.d(a, 'StaticQuery', function() {
          return f
        })
      var t = n(0),
        r = n.n(t),
      ...
      n.d(a, 'Link', function() {
        ...
        n.d(a, 'withPrefix', function() {
          return l.withPrefix
        }),
        n.d(a, 'navigate', function() {
          return l.navigate
        }),
        n.d(a, 'push', function() {
          return l.push
        ...
        n.d(a, 'navigateTo', function() {
          return l.navigateTo
        })
      var o = n(173),
        u = n.n(o)
      n.d(a, 'PageRenderer', function() {
        return u.a
      })
      var d = n(46)
    ...
    153: function(e, a, n) {
      ...
      var t = n(183),
        ...
        p = (function(e) {
          function a() {
            for (
              var a, n = arguments.length, t = new Array(n), r = 0;
              r < n;
              r++
            )
              t[r] = arguments[r]
            return (
              ((a = e.call.apply(e, [this].concat(t)) || this).state = {
                menuOpen: !1,
              }),
          ...
          return (
            ...
            (a.prototype.render = function() {
              var e = this
              return s.a.createElement(u.StaticQuery, {
                query: '2700609599',
                render: function(a) {
                      ...
                      s.a.createElement(
                        ...
                        s.a.createElement(
                          'a',
                          {
                            ...
                            className:
                              'navbar-burger ' +
                              (e.state.menuOpen ? 'is-active' : ''),
                            'aria-label': 'menu',
                            'aria-expanded': e.state.menuOpen,
                        ...
                        s.a.createElement(
                          ...
                          s.a.createElement(
                            ...
                            s.a.createElement(
                              ...
                              a.allDecksYaml.edges.map(function(e) {
                                return s.a.createElement(
                                  u.Link,
                                  {
                                    key: e.node.fields.slug,
                                    to: '/' + e.node.fields.slug + '/sign',
            ...
            render: function(e) {
              return s.a.createElement(
                ...
                s.a.createElement(
                  ...
                  s.a.createElement('html', { lang: 'en' })
                ),
                s.a.createElement(
                  'div',
    ...
    182: function(e, a, n) {
      ...
      var t = n(0),
        ...
        o = function(e) {
          var a = e.location,
            n = c.default.getResourcesForPathnameSync(a.pathname)
          return r.a.createElement(
            l.a,
    ...
    192: function(e) {
      e.exports = {
        data: {
          allDecksYaml: {
            edges: [
              { node: { name: 'Basics 1', fields: { slug: 'basics-1' } } },
              { node: { name: 'Basics 2', fields: { slug: 'basics-2' } } },
              { node: { name: 'Basics 3', fields: { slug: 'basics-3' } } },
              { node: { name: 'Numbers', fields: { slug: 'numbers' } } },
              { node: { name: 'Family', fields: { slug: 'family' } } },
              {
                node: {
                  name: 'Little words 1',
                  fields: { slug: 'little-words-1' },
                },
              },
              {
                node: {
                  name: 'Question words',
                  fields: { slug: 'question-words' },
                },
              },
              {
                node: {
                  name: 'Purpose words',
                  fields: { slug: 'purpose-words' },
                },
              },
              {
                node: {
                  name: 'Little words 2',
                  fields: { slug: 'little-words-2' },
                },
              },
              { node: { name: 'Misc 1', fields: { slug: 'misc-1' } } },
            ],
          },
        },
      }
